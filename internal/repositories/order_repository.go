...
func NewOrderRepository(l log.Logger, db mongo.Database) OrderRepository {
...
func (r *implOrderRepository) FindOneOrder(ctx context.Context, opt FindOneOrderOptions) (models.Order, error) {
	col := r.getCollection()
